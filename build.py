...
def parse_rc_features(feature):
    available_features = {
        'PrivacyMode': {
            'platform': ['windows'],
            'zip_url': 'https://github.com/fcurrk/RustDeskTempTopMostWindow/releases/download/v0.3/TempTopMostWindow_x64.zip',
            'checksum_url': 'https://github.com/fcurrk/RustDeskTempTopMostWindow/releases/download/v0.3/checksum_md5',
